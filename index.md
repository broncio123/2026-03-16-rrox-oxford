...
address: "Weston Library Lecture Theatre, Broad Street, Oxford"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
humantime: "9:45 am - 4:30 pm (GMT+1)"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Mcebisi Ntleki", "David Hemprich-Bennett", "Broncio Aguilar Sanjuan", "Daniel Valdenegro"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Hieu Thai", "Jo Guy", "Pek lm", "Gaurav Bhalerao"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/SW_Carpentries_Workshop_16-17_March # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
